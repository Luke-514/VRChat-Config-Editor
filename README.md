...
&emsp;<a href="https://github.com/Luke-514/VRChat-Config-Editor/releases/latest"><img src="image/download.png" width="200" alt="ダウンロードはこちら！"></a>  
...
>
>・保存先を変更しても、古い写真やキャッシュは移動しませんので、  
>&emsp;必要に応じて事前に移動したり、削除する必要があります  
>
>&emsp;キャッシュは**設定** → **デバッグ** → **保存されたキャッシュデータ**から削除可能です  
>&emsp;<img src="image/cache.png" width="70%" />  
  
# ツールの使い方
1.&nbsp;変更したい項目を編集します  
&nbsp;&emsp;<img src="image/mod.jpg" width="60%" />  
  
2.&nbsp;**適用**を押すと設定ファイルが適用されます  
&nbsp;&emsp;(既存の設定ファイルが存在する場合は、自動でバックアップが作成されます)  
&nbsp;&emsp;<img src="image/save.jpg" width="60%" />  
  
3.&nbsp;設定ファイルを手動で編集したい場合は、**設定ファイルを開く**を押してください  
&nbsp;&emsp;<img src="image/open.jpg" width="60%" />  
  
4.&nbsp;設定ファイルを削除したい場合は、**設定ファイルを削除**を押してください  
&nbsp;&emsp;(削除前に自動でバックアップが作成されます)  
&nbsp;&emsp;<img src="image/delete.jpg" width="60%" />  
  
5.&nbsp;バックアップされた設定に戻したい場合は、**バックアップから復元**を押して、  
&nbsp;&emsp;戻したい日時のファイルを選択してください  
&nbsp;&emsp;<img src="image/backup.jpg" width="60%" />  
  
# よくある質問
Q.&nbsp;ツールが起動しない  
A.&nbsp;Zipファイルを展開してからご利用ください  
&emsp;<img src="image/unzip.png" width="90%" />  
...
Q.&nbsp;設定をデフォルトに戻したい  
A.&nbsp;デフォルトにしたい項目を空にして**適用**を押すか、設定ファイルに他の設定を記載していないのであれば、  
&nbsp;&emsp;**設定ファイルを削除**を押して削除するとデフォルトに戻ります  
...
or  
[Booth](https://luke514.booth.pm/items/8602182)
